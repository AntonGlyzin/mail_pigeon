...
from mail_pigeon import MailClient
# app1
client1 = MailClient('app1', is_master=True, wait_server=True, cert_dir='/certificate')
```
...
from mail_pigeon import MailClient
# app2
client2 = MailClient('app2', is_master=False, wait_server=True, cert_dir='/certificate2')
```
...
client1 = MailClient('app1', is_master=True, wait_server=True, cert_dir='/certificate', encryptor=encryptor1)
```
